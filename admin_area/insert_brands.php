...
if(isset($_POST['insert_brand'])){
    ...
    if($numver>0){
        echo "<script>alert('This Brands already present in the database')</script>";
    }else{
...
<form action="" method="post" class="mb-2">
    ...
    <div class="input-group w-10 mb-2 m-auto">
        <input type="submit" class="bg-info border-1 p-2 my-2 " name="insert_brand" value="Insert Catagories">
    </div>
</form>