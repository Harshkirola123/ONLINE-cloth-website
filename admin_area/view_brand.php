...
<table class="table table-bordered mt-5">
    ...
    <tbody class="bg-secondary text-light text-center">
        ...
        <tr>
            ...
            <td><a href='index.php?delete_brand=<?php echo $Brands_id; ?>' type="button" class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid fa-trash'></i></a></td>
        </tr>
